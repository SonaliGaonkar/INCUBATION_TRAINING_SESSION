...
- a bug related to autorun [see](https://github.com/matepek/vscode-catch2-test-adapter/blob/HEAD/issues/36)
...
> Now, if there is 'something' in the [CHANGELOG](https://github.com/matepek/vscode-catch2-test-adapter/blob/HEAD/CHANGELOG.md) without date (ex.: "\[1.2.3]")
...
> - Creates a tag too.
> - Creates a [`GitHub release`](https://github.com/matepek/vscode-catch2-test-adapter/blob/HEAD/releases) for the tag and uploads the generated `.vsix` file.
...
- Variable substitution has been changed. (See [README](https://github.com/matepek/vscode-catch2-test-adapter/blob/HEAD/README.md) for details.)
